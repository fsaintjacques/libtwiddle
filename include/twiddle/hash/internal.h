...
static inline
uint64_t cread_u64(const void * const ptr)
{
    return * (uint64_t *) ptr;
}
...
static inline
uint64_t cread_u32(const void * const ptr)
{
    return * (uint32_t *) ptr;
}
...
static inline
uint64_t cread_u16(const void * const ptr)
{
    return * (uint16_t *) ptr;
}
...
static inline
uint64_t cread_u8(const void * const ptr)
{
    return * (uint8_t *) ptr;
}
